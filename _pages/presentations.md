...
------
* **Ingram, J.D.**, Kashyap, V. L., Klingenberg, B., and Meng, X.-L. (2025). *Systematic Errors in Solar Flare Statistics: When Poisson Assumptions Lead to Underestimated Uncertainties* [[Oral Presentation](https://sites.google.com/uah.edu/sys2025/program?authuser=0)]. Sys2025: Systematic and Measurement Errors across the Sciences - AstroStatistics and Data Science.
* **Ingram, J.D.**, Kashyap, V. L., Klingenberg, B., and Meng, X.-L. (2025). *Solar Flare Statistics Don’t Follow Poisson: Overdispersion from Overlapping Active Regions* [[Oral Presentation](https://hea-www.harvard.edu/astrostat/CHASC_2526/)]. International CHASC Astro-Statistics Center Workshop: Topics in Astrostatistics.
